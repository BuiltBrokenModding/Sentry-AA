...
public class GuiSettings extends GuiContainerBase
{
    ...
    protected void actionPerformed(GuiButton button)
    {
        ...
        {
            returnGui.fof.sendPacketToServer(returnGui.fof.getHost().getPacketForData(3, true));
        }
        else if (button.id == 2)
        {
            returnGui.fof.sendPacketToServer(returnGui.fof.getHost().getPacketForData(3, false));
        }
        else if (button.id == 3)
        {
            returnGui.fof.sendPacketToServer(returnGui.fof.getHost().getPacketForData(4));
        }
        else if (button.id == 4)
        {
            pos = 2;
